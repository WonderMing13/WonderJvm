...
public class AsmUtils {
    ...
    private static String getCommonSuperClassImplByAsm(String type1, String type2, ClassLoader targetClassLoader) {
        ...
        try {
            ...
            final CoreClassStructure classStructureOfType1 = new AsmClassStructure(inputStreamOfType1, targetClassLoader);
            final CoreClassStructure classStructureOfType2 = new AsmClassStructure(inputStreamOfType2, targetClassLoader);
            ...
            CoreClassStructure classStructure = classStructureOfType1;
            do {
            ...
            return AsmClassStructure.changeInternalClassName(classStructure.getJavaClassName());
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        } finally {
